...
public class Interstate extends JPanel {
	...
	public Interstate() throws IOException, InterruptedException {	
		...
		// Finds center and displays it on the graph on starting the program
		graphicalMap.findCenter();
				
		// Finds diameter and displays the path upon starting the program
		graphicalMap.findDiameter();
